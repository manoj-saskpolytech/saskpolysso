...
import { initialDataSignUp } from "../SignUp/initialDataSignUp"
...
import * as validationLib from "../SignUp/validationAccountSignUp"
        ...
        onSubmit: async (values, { setSubmitting }) => {
            try {
                ...
                const result =
                    ...
                    if (result === "User Email or User Name is already exists or User Not Verified") {
                        setShowToast(true)
                        seterrorToastMessageType("error")
                        seterrorToastMessage(
                            generateLocalizationMsg("not_verified",'User Email or User Name is already exists or User Not Verified, Please try with different email ID or User Name or Verify the User')
                        )
                    ...
                    seterrorToastMessage(
                        generateLocalizationMsg("signup_success","SignUp Successfully ,OTP Sent to your Mail ID")
                    )
    ...
    const handleOtpSubmit = async (
        ...
        try {
            ...
            if (errorMessages.includes(isValidOtp)) {
                ...
                seterrorToastMessageType("success")
                seterrorToastMessage(
                    generateLocalizationMsg("account_success_Login","Your account is successfully ready to Login"),
                )
                setshowDialogForOTP(true)
            ...
            seterrorToastMessageType("error")
            seterrorToastMessage(
                error.message || generateLocalizationMsg("otp_submit_error","An error occurred during OTP validation"),
            )
        }
    }
        ...
        <ThemeProvider theme={theme}>
            ...
            >
                ...
                >
                    ...
                    <div style={{display:"flex",justifyContent:"end",alignItems:"center",height:"19px",marginLeft:"7%"}}>
                    ...
                    <Box className="SignInHeaderRightStyle">
                        <Typography sx={{ fontSize: '14px', fontWeight: 'normal' }}>
                                ...
                                {generateLocalizationMsg(
                                    "have_account",
                                    "Already having a Proxikle account?",
                                )}
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <Typewriter
                                    options={{
                                        strings: [generateLocalizationMsg("signup_analyze","Analyze"), generateLocalizationMsg("signup_Build","Build")],
                                        autoStart: true,
                                        loop: true,
                                        cursor: "_",
                                        delay: 200,
                            ...
                            <span style={{ color: "#253858", position: 'relative', left: '-6px' }}>
                               {generateLocalizationMsg("signup_title","the next big thing through us").replace("Analyze ", "")}
                            </span>
                        </Typography>
                        <Box sx={{ margin: "10px 40px 0px 40px" }}>
                            <Grid container spacing={2}>
                                ...
                                <Grid item xs={12}>
                                    <CustomCheckbox
                                        ...
                                        label={generateLocalizationMsg(
                                            "data_storage",
                                            "My Data will be stored in United States",
                                        )}
                                        formik={formik}
                                        readOnly={true}
                                    />
                                ...
                                <Grid item xs={12}>
                                    <CustomCheckbox
                                        ...
                                        label={generateLocalizationMsg(
                                            "newsletters",
                                            "Send me Web3 newsletters, Proxikle Tutorials & marketing emails of Proxikle Products.",
                                        )}
                                        formik={formik}
                                        readOnly={false}
                                    />
                                ...
                                <Grid item xs={12}>
                                    <CustomCheckbox
                                        ...
                                        label={
                                            <span>
                                                {generateLocalizationMsg("terms_policy_accept","I accept the")}{" "}
                                                <Link
                                                    href="#"
                                                    variant="h6"
                                                    sx={{
                                                ...
                                                >
                                                    {generateLocalizationMsg("site_terms_link","Site Terms")}
                                                </Link>{" "}
                                                {generateLocalizationMsg("terms_policy_and","and")}{" "}
                                                <Link
                                                    href="#"
                                                    variant="h6"
                                                    sx={{
                                                ...
                                                >
                                                    {generateLocalizationMsg("terms_policy_accept","Privacy Policy")}
                                                </Link>
                                            </span>
                                        }
                                        formik={formik}
                            ...
                            >
                                {generateLocalizationMsg("signin_using_or","or")}
                            </Typography>
                        </Box>
                        {/* <Stack
              direction="row"
              ...
              >
                ...
                >
                    <b>
                        ...
                        {generateLocalizationMsg(
                            "footer",
                            "2024 Proxikle Inc. All Rights Reserved",
                        )}
                    </b>
                </Typography>
            </Box>
