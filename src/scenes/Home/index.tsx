    ...
    <Container  sx={{ height:"100vh",maxWidth:"100% !important",minWidth:"200px" }} className='mainForm'>
      ...
      <Stack direction="row" spacing={3} sx={{ mt: 5,justifyContent:"center",alignItems:"center" }}>
        ...
        <CardHeader
          ...
          title={
            <Typography variant="h5" component="div" sx={{ display: "flex", alignItems: "center"}}>
              <img src="https://proxiklestatic.com/products/accounts/explorer_accounts_logo.svg"alt="Analytics Icon" style={{ width: '35px' }} />
            </Typography>
          }
          action={
            <Box 
        ...
        <CardHeader
          ...
          title={
            <Typography variant="h5" component="div" sx={{ display: "flex", alignItems: "center"}}>
              <img src="https://proxiklestatic.com/products/accounts/nova_accounts_logo.svg" alt="Analytics Icon" style={{ width: '25px' }} />
            </Typography>
          }
          action={
            <Box 
      ...
      >
        <b>&copy;{generateLocalizationMsg("footer","2024 Proxikle Inc. All Rights Reserved")}</b>
      </Typography>
    </Container>
  );
};
